                        ...
                        <div class="modal-body">
                            <form id="manageCategorie<?= $categorie['id'];?>" action="../scripts/manageCategorie.php?idTopic=<?= $categorie['id'] ?>" enctype ="multipart/form-data" method="POST" >
                                ...
                                <div class="row modify-userPassword">
                                    <div class="col-12">
                                        <label for="modify-adminPasswordInput<?= $categorie['id'];?>" class="fw-bold">Votre mot de passe</label>
                                        <input id="modify-adminPasswordInput<?= $categorie['id'];?>" class="form-control" type="password" name="modify-adminPasswordInput" placeholder="Veuillez saisir votre mot de passe" required="required">
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-body">
                            <form id="deleteCategorie<?= $categorie['id'];?>" action="../scripts/delCategorie.php?idTopic=<?= $categorie['id'];?>" method="POST" >
                                <div class="deleteFormInfo">
                                    ...
                                    <div class="col">
                                        <label for="delete-userPasswordInput<?= $categorie['id'];?>" class="fw-bold">Votre mot de passe</label>
                                        <input id="delete-userPasswordInput<?= $categorie['id'];?>" class="form-control" type="password" name="delete-userPasswordInput" placeholder="Veuillez saisir votre mot de passe" required="required">
                                    </div>
                                </div>
                            </form>
                        </div>
